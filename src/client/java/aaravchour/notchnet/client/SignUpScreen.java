...
public class SignUpScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addDrawableChild(ButtonWidget.builder(Text.literal("Sign Up"), button -> {
            signUp(this.usernameField.getText(), this.passwordField.getText());
    ...
    private void signUp(String username, String password) {
        try {
            ...
            if (code == 200) {
                this.client.setScreen(new SignInScreen());
            } else {
